...
/* ==================================================================
   Roster (mit Supabase + Bearbeiten)
   ================================================================== */
...
function RosterTab() {
  ...
  async function saveMember(e: React.FormEvent) {
    ...
    // Avatar nur hochladen, wenn eine Datei gewählt wurde
    if (draft.avatarFile) {
      try {
          ...
          <tbody>
            {list.map((s) => (
              <tr key={s.id}>
                ...
                <td>
                  <span className={gameTagClass(s.spiel)}>
                    {s.spiel}
                  </span>
                </td>
                <td>{s.clan || '—'}</td>
                ...
                >
                  <button
                    className="lg-btn"
                    style={{
                      padding: '0.3rem0.6rem                      fontSize: '0.75rem',
                    }}
                    onClick={() => setOpen(s)}
                  >
                    Details
                  ...
                  <button
                    ...
                    on={()List((l) => l.filter((x) => x.id !== s.id))
                    }
                  >
                    ×
                  </button>
